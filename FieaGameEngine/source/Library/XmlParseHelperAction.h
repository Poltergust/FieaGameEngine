...
namespace Library
{
	...
	*/
	...
	public:
		...
		*/
		explicit XmlParseHelperAction() = default;
		...
		* @param sharedData 	the data to store the results of the parse; must be of type XmlParseHelperAction::SharedData
		...
		*/
		virtual XmlParseHelperAction* Clone() const;
