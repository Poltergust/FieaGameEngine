...
namespace Library
{
	...
	*/
	...
	public:
		...
		*/
		explicit XmlParseHelperSector() = default;
		...
		* @param sharedData 	the data to store the results of the parse; must be of type XmlParseHelperSector::SharedData
		...
		*/
		virtual XmlParseHelperSector* Clone() const;
